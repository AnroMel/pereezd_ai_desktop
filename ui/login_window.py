...
class LoginWindow(QMainWindow):
    ...
    def _build_ui(self):
        ...
        bg_frame = BackgroundFrame("assets/img/login_bg.png")
        ...
        pixmap = QPixmap("assets/img/logo.png")
        ...
        login_icon = QIcon("assets/img/icon_user.png")
        ...
        lock_icon = QIcon("assets/img/icon_lock.png")
